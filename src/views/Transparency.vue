<template>
  <v-container class="mt-12 pt-12">
    ...
    <p>
      For hourly workers (including workers on cloud platforms like <a
    ...
    <p>
      ...
      Nonprofit Explorer by Pro Publica, for example. If you search for our taxes on other sites, you'll probably want
      to search under "Impactstory;" we
    ...
    <blockquote>
      <div>
        ...
        initiatives that support the research community can be run and sustained."
      </div>
      <div>
        <em>
          source: <a href="https://openscholarlyinfrastructure.org/about/">POSI website</a>
        </em>
      </div>
    </blockquote>
    <p>
    ...
    <p>
      ...
      <a href="https://archive.softwareheritage.org/browse/search/?q=ourresearch&with_visit=true&with_content=true">Software
        Heritage archive,</a> maintained outside our control a by third-party nonprofit dedicated to the long-term
    ...
    <p>
      You can see a list of our papers on ORCID (<a
        ...
        href="https://scholar.google.com/citations?user=1YLq0XMAAAAJ&hl=en">Heather</a>); lamentably, the Google ones
      are more complete.
    </p>


    <div class="text-h4" id="data">Data</div>
    <p>
      We make the data behind our projects open. For example, you can download a full dump of the <a
        href="https://unpaywall.org">Unpaywall</a> database, all 120M+ rows of it, any time. That data is also available
      via a public, open API with generous rate limits (100,000 calls per day). More specific details on data dumps and
      APIs are available on individual project pages.
    </p>
    <p>
      Much of our data consists of "facts" that have no copyright (see <a
        href="https://www.crossref.org/blog/crossrefs-board-votes-to-adopt-the-principles-of-open-scholarly-infrastructure/">this
      Crossref blog post</a> for more discussion of this). We can't apply a license to these (nor, appealingly, can
      anyone else). Where copyright is applicable, though, our data is
      <a href="https://creativecommons.org/share-your-work/public-domain/cc0/">CC0, "no rights reserved."</a>
    </p>
